...
public class UrlGenerationUtil {
    ...
    /**
     * This method gives the servelet HTTPS host of the given productGroup instance
     *
     * @param instance
     * @return
     */
    public static String getServeletHttpsHost(Instance instance) {
        String managerHost = "";
        managerHost = instance.getHosts().get(ContextXpathConstants.SERVELET_HTTPS);
        return managerHost;
    }


    /**
     * This method gives the servelet HTTP host of the given productGroup instance
     *
     * @param instance
     * @return
     */
    public static String getServeletHttpHost(Instance instance) {
        String managerHost = "";
        managerHost = instance.getHosts().get(ContextXpathConstants.SERVELET_HTTP);
        return managerHost;
    }


    /**
     * This method gives the Pass-through HTTPS host of the given productGroup instance
     *
     * @param instance
     * @return
     */
    public static String getPassthroughHttpsHost(Instance instance) {
        String managerHost = "";
        managerHost = instance.getHosts().get(ContextXpathConstants.PASSTHROUGH_HTTPS);
        return managerHost;
    }


    /**
     * This method gives the Pass-through HTTP host of the given productGroup instance
     *
     * @param instance
     * @return
     */
    public static String getPassthroughHttpHost(Instance instance) {
        String managerHost = "";
        managerHost = instance.getHosts().get(ContextXpathConstants.PASSTHROUGH_HTTP);
        return managerHost;
    }
